...
signed short SDBGTaskCNT=0 , SDBGTaskHz=0;                 //System debug task internal frequency value
...
void setup()
{
  ...
  xTaskCreate( vSUSBTask       ,( signed char * ) "SUSB" ,configMINIMAL_STACK_SIZE, NULL, 2, NULL );      //Init serial usb task for send information (String format) to PC 
  xTaskCreate( vDXLWTask       ,( signed char * ) "DXLW" ,configMINIMAL_STACK_SIZE, NULL, 4, NULL );      //Init Real Time Clock task for calculate internal frequency of tasks
  ...
  xTaskCreate( vSDBGTask       ,( signed char * ) "SDBG" ,configMINIMAL_STACK_SIZE, NULL, 4, NULL );      //Init Real Time Clock task for calculate internal frequency of tasks
