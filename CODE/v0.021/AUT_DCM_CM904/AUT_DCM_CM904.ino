...
signed short SIMUTaskCNT=0 , SIMUTaskHz=0;                 //IMU task internal frequency value
signed short SUSBTaskCNT=0 , SUSBTaskHz=0;     //Serial task internal frequency value
...
void setup()
{
  Dxl.begin(1);        delay(500);               // Config onboard LED 
